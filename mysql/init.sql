...
('dummy_admin_memo_id3', 'dummy_admin_id', 'アプリで使用するAPIキー: flag{dummy_flag5}', 'secret', 'dummy_admin_memo_pass1');

INSERT IGNORE INTO memos (id, user_id, body, visibility, password) VALUES
('dummy_super_admin_memo_id1', 'dummy_super_admin_id', '最高権限のシークレット: flag{dummy_flag6}', 'secret', 'dummy_super_admin_memo_pass1');